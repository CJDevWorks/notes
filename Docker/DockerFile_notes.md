...
What's an EntryPoint? why have a common entry_point ?

Common Docker File Commands

- FROM
    Base Image and all its layers

- COPY
    includes files from outside the image
- ADD
    includes files from outside the image
...
- WORKDIR
    to set user and working directory for subsequent layers

- USER - Why it matters? Most of things done as root, after certain stage things should happens as USER and not as root therefore should be set
